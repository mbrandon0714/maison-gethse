    ...
    <>
      ...
      <main>
        ...
        <section className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ paddingTop: "var(--nav-h)" }}>
          <div className="absolute inset-0 section-bg" style={{ backgroundImage: "url(/images/bg-hero.jpg)", backgroundSize: "cover", backgroundPosition: "center 40%", opacity: 0.07 }} />
        ...
        <section id="brand" className="py-32 px-6 md:px-12 relative overflow-hidden" style={{ background: "var(--bg-surface)", transition: "background 0.5s" }}>
          <div className="absolute inset-0 section-bg" style={{ backgroundImage: "url(/images/bg-brand.jpg)", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.08 }} />
        ...
        <section id="garden" className="py-32 px-6 md:px-12 relative overflow-hidden" style={{ background: "var(--bg-deep)", transition: "background 0.5s" }}>
          <div className="absolute inset-0 section-bg" style={{ backgroundImage: "url(/images/bg-garden.jpg)", backgroundSize: "cover", backgroundPosition: "center 30%", opacity: 0.07 }} />
        ...
        <section className="py-24 px-6 md:px-12 relative overflow-hidden" style={{ background: "var(--bg-mid)", transition: "background 0.5s" }}>
          <div className="absolute inset-0 section-bg" style={{ backgroundImage: "url(/images/bg-community.jpg)", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.09 }} />
